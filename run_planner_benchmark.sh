...
for folder in pddl_gen/src/main/resources/output/pddl/*/; do
	...
	for val in $(seq 1 $num_of_traces); do
	  ...
	  (wsl -e time -v java -Xmx16g -jar "${gen_path}/src/main/resources/output/enhsp3.jar" -o ${folder}/domain.pddl -f ${folder}/problem1.pddl -planner opt-blind) 2>&1 | tee -a $results_file
